...
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`InfraFile`]({{  brane_docs_root }}/brane_cfg/infra/struct.InfraFile.html) in [`brane_cfg/infra.rs`]({{  brane_docs_root }}/src/brane_cfg/infra.rs.html)._
