# The node file
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`NodeConfig`]({{  brane_docs_root }}/brane_cfg/node/struct.NodeConfig.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
### Central nodes
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`CentralConfig`]({{  brane_docs_root }}/brane_cfg/node/struct.CentralConfig.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
### Worker nodes
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`WorkerConfig`]({{  brane_docs_root }}/brane_cfg/node/struct.WorkerConfig.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
### Proxy nodes
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`ProxyConfig`]({{  brane_docs_root }}/brane_cfg/node/struct.ProxyConfig.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
### Private services
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`PrivateService`]({{  brane_docs_root }}/brane_cfg/node/struct.PrivateService.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
### Public services
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`PublicService`]({{  brane_docs_root }}/brane_cfg/node/struct.PublicService.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
### Variable services
_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> [`PrivateOrExternalService`]({{  brane_docs_root }}/brane_cfg/node/enum.PrivateOrExternalService.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._
...
- `!external`: Defines an externally running service. It has one field only:
  ...
  (_<img src="../../assets/img/source.png" alt="source" width="16" style="margin-top: 3px; margin-bottom: -3px;"/> The external map variant is defined as [`ExternalService`]({{  brane_docs_root }}/brane_cfg/node/struct.ExternalService.html) in [`brane_cfg/node.rs`]({{  brane_docs_root }}/src/brane_cfg/node.rs.html)._)
